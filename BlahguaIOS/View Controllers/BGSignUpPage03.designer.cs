...
namespace BlahguaMobile.IOS
{
	...
	partial class BGSignUpPage03
	{
		...
		UILabel badgeReceivedLabel { get; set; }

		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UIButton checkBtn { get; set; }

		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UITextField emailAddrField { get; set; }

		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UIButton noCodeBtn { get; set; }

		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UILabel preBadgeLabel { get; set; }
		...
		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UIButton skipBtn { get; set; }

		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UITextField verificationField { get; set; }

		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UIButton verifyBtn { get; set; }
