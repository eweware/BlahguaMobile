...
namespace BlahguaMobile.AndroidClient.Screens
{
    public partial class MainFragment
    {
        ...
        {
            LayoutInflater inflater = (LayoutInflater)homeActivity.GetSystemService(Context.LayoutInflaterService);

            //get the pop-up window i.e.  drop-down layout
            LinearLayout layout = (LinearLayout)inflater.Inflate(Resource.Layout.popup_signature, (ViewGroup)fragment.FindViewById(Resource.Id.popUpView));

            //get the view to which drop-down layout is to be anchored
			Button layout1 = (Button)fragment.FindViewById(Resource.Id.btn_signature);
