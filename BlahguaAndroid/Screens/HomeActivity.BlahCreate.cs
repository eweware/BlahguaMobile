...
{
    public partial class HomeActivity : IUrlImageViewCallback, View.IOnTouchListener
    {
        enum MyBlahType
        {
		...
		public void triggerCreateBlock()
		{
			...
			else
			{
				...
				if (BlahguaAPIObject.Current.CurrentChannelList != null) {
					...
					LeftMenu.Adapter = new ArrayAdapter<string> (this, Resource.Layout.item_menu, channels);
				}
			}
		}
